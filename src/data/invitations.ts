...
export const invitations: InvitationConfig[] = [
  {
    ...
    couple: {
      ...
      bride: {
        ...
        parents: [
          'The Daughter of',
          'Mr. Lorem ipsum dolor sit amet',
          'Mrs. Lorem ipsum dolor sit amet',
        ],
    ...
    media: {
      ...
      heroVideo:
        'https://is3.cloudhost.id/externalgroovepublic/video%20groove/japan%20vibe.mp4',
      heroPoster:
      ...
      giftImage:
        'https://groovepublic.com/wp-content/uploads/2025/01/dexter-hualin-00179.jpg',
      rsvpImage:
    ...
    countdown: {
      ...
      calendar: {
        ...
        location:
          'Jl. Taman Palem Lestari Barat No.1 Blok B 13, Cengkareng Barat, Jakarta, 11730, Indonesia',
    ...
    events: {
      ...
      details: [
        ...
        },
        {
          ...
          time: '8 AM - 10 PM',
          text:
            'If you are unable to attend in person, we invite you to celebrate with us through our live streaming.',
      ...
      accounts: [
        {
          ...
          bank: 'Bank Mandiri',
          number: '00008888123',
          holder: 'Groove Public Invitation',
        },
        {
          id: 'bca-main',
          bank: 'Bank BCA',
    ...
    rsvp: {
      ...
      comments: [
        {
          guestName: 'Belaa anis',
          wishes:
            'Over the next year, Dexter and Hualin spent more and more time together. They explored the beauty of Japan.',
        ...
        },
        {
          ...
          wishes:
            'Over the next year, Dexter and Hualin spent more and more time together. They explored the beauty of Japan.',
          createdAt: '2025-03-04T07:00:00.000Z',
        },
        {
          guestName: 'Yoku',
          wishes:
            'Over the next year, Dexter and Hualin spent more and more time together. They explored the beauty of Japan.',
          createdAt: '2025-03-04T06:00:00.000Z',
        },
      ],
    },
    footer: {
