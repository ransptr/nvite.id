-- ============================================================
-- 002_seed_claire.sql
-- Seeds admin profile (plan=pro) + the 'claire' demo invitation
-- Owner: admin@mail.com  UUID: 8b94cac0-9bc9-49c6-a659-8472d45eb153
-- ============================================================

insert into profiles (id, plan)
values ('8b94cac0-9bc9-49c6-a659-8472d45eb153', 'pro')
on conflict (id) do update set plan = 'pro';

insert into invitations (owner_id, slug, is_published, content)
values (
  '8b94cac0-9bc9-49c6-a659-8472d45eb153',
  'claire',
  true,
  $json${
    "slug": "claire",
